...
onMounted(() => {
  ...
  phantomHeight.value = props.listData.length * props.estimateItemHeight;
...
<template>
  <div ref="container" class="w-[400px] h-[1000px] overflow-auto relative" @scroll="onScroll">
    <!-- 虚拟撑开区 -->
    <div :style="{ height: `${phantomHeight}px` }"></div>
    <!-- 可视区 -->
    <div class="absolute top-0 left-0 w-full" :style="{ transform: `translateY(${startOffset}px)` }">
      <div
